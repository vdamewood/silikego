// Do not use this file while building Silikego or building a program
// that uses Silikego. Instead, use the file generated by CMake.

// Put silikego/include-ide in your IDE's include search list
